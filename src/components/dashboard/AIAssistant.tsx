  ...
  const quickActions = [
    {
      icon: Calendar,
      label: "Timeline Help",
      query: "Help me create a wedding day timeline",
    },
    {
      icon: DollarSign,
      label: "Budget Tips",
      query: "How should I allocate my wedding budget?",
    },
    {
      icon: Users,
      label: "Guest Management",
      query: "Tips for managing wedding guests and RSVPs",
    },
    {
      icon: Camera,
      label: "Photo Planning",
      query: "How to plan wedding photography timeline?",
    },
  ];
