...
const DraggableComponent = ({
  ...
  const ref = useRef<HTMLDivElement>(null); // DOM ref
...
const DropZone = ({
  ...
  // Attach the drop target to the DOM ref
  useEffect(() => {
    if (dropRef.current) {
...
const WeddingPageBuilder = () => {
  ...
  const availableComponents: Component[] = [
    ...
    { id: 'gallery', type: 'gallery', name: 'Photo Gallery', icon: Image },
  ...
  const handleDrop = useCallback((item: Component) => {
  ...
  const updateComponentStyles = (id: string, styles: any) => {
    setDroppedComponents(prev =>
      prev.map(comp =>
      ...
      case 'hero':
        return (
          <div className="text-center">
            <h1 className="text-2xl font-bold mb-2">{component.content?.title || 'Wedding Title'}</h1>
            <p className="text-lg">{component.content?.subtitle || 'Wedding Date'}</p>
            <p className="text-sm mt-2">{component.content?.venue || 'Venue Location'}</p>
          </div>
        );
      case 'story':
        return (
          <div>
            <h2 className="text-xl font-semibold mb-2">{component.content?.title || 'Our Story'}</h2>
            <p>{component.content?.content || 'Your love story goes here...'}</p>
          </div>
        );
      case 'gallery':
        return (
    ...
    <DndProvider backend={HTML5Backend}>
      <div className="h-full flex flex-col">
        ...
        <div className="flex-1 flex gap-8">
          <div className={`w-80 rounded-3xl p-6 shadow-lg border h-fit ${
            isDarkMode
                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => updateComponentContent(selectedComponent.id, { subtitle: e.target.value })}
                            className={`w-full px-3 py-2 rounded-xl border transition-colors ${
                              isDarkMode
                                ? 'bg-slate-700 border-slate-600 text-white'
                                : 'bg-white border-slate-300 text-slate-900'
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => updateComponentContent(selectedComponent.id, { venue: e.target.value })}
                            className={`w-full px-3 py-2 rounded-xl border transition-colors ${
                              isDarkMode
                                ? 'bg-slate-700 border-slate-600 text-white'
                                : 'bg-white border-slate-300 text-slate-900'
                      ...
                      <div>
                        ...
                        <div className="flex gap-2">
                          <input
                            ...
                            onChange={(e) => updateComponentStyles(selectedComponent.id, { backgroundColor: e.target.value })}
                      ...
                      <div>
                        ...
                        <div className="flex gap-2">
                          <input
                            ...
                            onChange={(e) => updateComponentStyles(selectedComponent.id, { textColor: e.target.value })}
                            className="w-12 h-8 rounded border"
                          />
                          <input
                            type="text"
