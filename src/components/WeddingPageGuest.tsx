  ...
  const messages = [
    {
      ...
      guest: "Sarah Johnson",
      message:
        "Congratulations! Your wedding was absolutely beautiful. Wishing you both a lifetime of happiness!",
      date: "2024-01-15",
    },
    {
      id: 2,
      guest: "Michael Brown",
      message:
        "Such a wonderful celebration! Thank you for including us in your special day. Love you both!",
      date: "2024-01-14",
    },
    {
      id: 3,
  ...
  return (
    ...
    >
      <div className="text-center mb-12">
        <h2
          className={`text-4xl font-light mb-6 tracking-tight ${isDarkMode ? "text-white" : "text-slate-900"}`}
        >
          Wedding Guestbook
        </h2>
