...
export default function VintageGift(props: VintageGiftProps) {
  ...
  console.log("VintageGift props:", props);
  ...
  const openPurchase = (gift: GiftItem) => {
    console.log("VintageGift openPurchase called with gift:", gift);
  ...
  const handlePurchase = async (data: {
    ...
    console.log("VintageGift handlePurchase called with:", {
      selected,
      userId: props.userId,
      data,
    });
