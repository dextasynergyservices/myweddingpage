...
export default function LuxuryGift(props: LuxuryGiftProps) {
  ...
  console.log("LuxuryGift props:", props);
  ...
  const openPurchase = (gift: GiftItem) => {
    console.log("LuxuryGift openPurchase called with gift:", gift);
  ...
  const handlePurchase = async (data: {
    ...
    console.log("LuxuryGift handlePurchase called with:", { selected, userId: props.userId, data });
