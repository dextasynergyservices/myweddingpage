...
export default function RusticGift(props: RusticGiftProps) {
  ...
  console.log("RusticGift props:", props);
  ...
  const openPurchase = (gift: GiftItem) => {
    console.log("RusticGift openPurchase called with gift:", gift);
  ...
  const handlePurchase = async (data: {
    ...
    console.log("RusticGift handlePurchase called with:", { selected, userId: props.userId, data });
