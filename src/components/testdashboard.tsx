...
type Couple = {
  ...
  const navigationItems = [
    ...
    { id: 'builder', label: 'Page Builder', icon: Layout, description: 'Drag & drop wedding page builder' },
    ...
    { id: 'checklist', label: 'Checklist', icon: CheckSquare, description: 'Interactive planning checklist' },
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-8">
                    <div className="grid grid-cols-2 gap-6 text-center">
                      <div>
                        <p className={`text-2xl font-light ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>
                          {wedding.views}
                        </p>
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${
      ...
      <div className="flex">
        {/* Sidebar Navigation */}
        <div className={`w-80 min-h-screen border-r ${
