        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <p className={`leading-relaxed mb-6 text-lg font-light ${
              ...
              Our journey began five years ago when we met at a coffee shop in downtown Portland.
              What started as a chance encounter over spilled coffee became the foundation of our beautiful love story.
            </p>
