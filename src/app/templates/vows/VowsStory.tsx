    ...
    <section className={`py-32 ${styles.bgBackground}`}>
      <div className={styles.containerWedding}>
        ...
        >
          ...
          >
            Every love story is beautiful, but ours is our favorite. From our first meeting to this
            magical moment, here&apos;s how our journey began.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            <div className={`${styles.elegantCard} p-8 md:p-12`}>
              ...
              <p className={`${styles.fontBody} ${styles.textMuted} leading-relaxed mb-6`}>
                It was a beautiful spring afternoon at the local coffee shop. Sarah was reading her
                favorite book when Michael accidentally spilled his coffee. What started as an
                embarrassing moment turned into the most wonderful conversation that lasted for
                hours.
              </p>
            </div>
          </div>
          ...
          >
            <div className={`relative overflow-hidden ${styles.roundedLg} ${styles.shadowElegant}`}>
              <Image
                src={storyImage1}
                alt="Sarah and Michael's first photo together"
          ...
          >
            <div className={`relative overflow-hidden ${styles.roundedLg} ${styles.shadowElegant}`}>
              <Image
                src={storyImage2}
                alt="Sarah and Michael during their engagement"
                className="w-full h-auto object-cover"
                width={600}
                height={400}
              />
          ...
          >
            <div className={`${styles.elegantCard} p-8 md:p-12`}>
              ...
              <p className={`${styles.fontBody} ${styles.textMuted} leading-relaxed mb-6`}>
                On a snowy December evening, Michael took Sarah back to that same coffee shop where
                they first met. As the snow fell gently outside, he got down on one knee and asked
                her to be his forever. Of course, she said yes!
              </p>
            </div>
          </div>
        </div>
