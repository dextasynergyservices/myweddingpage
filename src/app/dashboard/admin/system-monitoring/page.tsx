...
export default function SystemMonitoringPage() {
  ...
  const fetchSystemData = async () => {
    try {
      ...
      // Fetch system health
      const healthResponse = await fetch("/api/admin/system/health", { credentials: "include" });
      ...
      const metricsResponse = await fetch("/api/admin/system/metrics", { credentials: "include" });
