...
const GoogleAuthButton: React.FC = () => {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.98 }}
      className={`w-full flex items-center justify-center gap-3 py-3 px-6 rounded-2xl border transition-all duration-300 ${
        isDarkMode
          ? "bg-slate-700/50 border-slate-600 text-white hover:bg-slate-700 hover:border-slate-500"
          : "bg-white/50 border-slate-300 text-slate-700 hover:bg-white hover:border-slate-400"
